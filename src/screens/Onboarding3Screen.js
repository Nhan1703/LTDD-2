...
import Onboarding3Mockup from '../components/Onboarding3Mockup';
import { COLORS } from '../constants/colors';

export default function Onboarding3Screen({ onNext, onPrev, onSkip, onSelectStep }) {
  return (
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.bottomCard}>
          ...
          <View style={styles.bottomActionsRow}>
            ...
            {/* Pagination Indicators (3 Dots - Dot 3 Active) */}
            <View style={styles.paginationContainer}>
              ...
              <TouchableOpacity
                onPress={() => onSelectStep && onSelectStep(2)}
                activeOpacity={0.8}
              >
                <View style={[styles.dot, styles.inactiveDot]} />
              </TouchableOpacity>
