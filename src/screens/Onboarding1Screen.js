...
import Onboarding1Mockup from '../components/Onboarding1Mockup';
import { COLORS } from '../constants/colors';

export default function Onboarding1Screen({ onNext, onSkip, onSelectStep }) {
  return (
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.bottomCard}>
          ...
          <View style={styles.bottomActionsRow}>
            ...
            {/* Pagination Indicators (3 Dots - Dot 1 Active) */}
